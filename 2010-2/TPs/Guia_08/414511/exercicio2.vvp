...
//1) FAZER um circuito lógico para a função abaixo,após simplificá-la pelo método de Quine-McCluskey:
...
initial begin: main
	$display("Guia 08 - Nádia de Souza Maciel Vieira Ferreira - Matricula: 414511");
...
/* Resultado obtido
    ...
    Guia 08 - Nádia de Souza Maciel Vieira Ferreira - Matricula: 414511
